...
class EReceipt2Screen extends StatefulWidget {
  EReceipt2Screen({Key? key}) : super(key: key);

  @override
  State<EReceipt2Screen> createState() => _EReceipt2ScreenState();
}

class _EReceipt2ScreenState extends State<EReceipt2Screen> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            MyButton(btnName: "Download Ticket", click: () {}),
          ],
        ),
      ),
    );
